...
class Text extends Component {
    ...
    _onInput() {
        ...
        textareaStyle.width = `${Math.ceil(obj.getScaledWidth() / ratio)}px`;
        textareaStyle.height = `${Math.ceil(obj.getScaledHeight() / ratio)}px`;
    }
    ...
    _onBlur() {
        ...
        let transWidth = (editingObj.getScaledWidth() / ratio) - (editingObjInfos.width / ratio);
        let transHeight = (editingObj.getScaledHeight() / ratio) - (editingObjInfos.height / ratio);
    ...
    _changeToEditingMode(obj) {
        ...
        this._editingObjInfos = {
            ...
            width: this._editingObj.getScaledWidth(),
            height: this._editingObj.getScaledHeight()
        };
